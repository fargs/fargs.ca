...
CREATE VIEW [Private].[TaskStatus]
AS
SELECT t.Id
	, t.TaskStatusId
...
FROM (
	SELECT t.Id
	, TaskStatusId = dbo.GetTaskStatusId2(t.CompletedDate, t.IsObsolete, tt.TaskType, c.CompletedDate, c.IsObsolete, ct.TaskType, GETDATE(), sr.AppointmentDate)
