CREATE PROC [dbo].[_Migrations_DependentTasks]
AS

INSERT INTO dbo.ServiceRequestTask (ObjectGuid, ServiceRequestId, TaskId, TaskName, ResponsibleRoleId, [Sequence], TaskPhaseId, Guidance, DependsOn, ShortName, t.[Workload])
SELECT newid(), sr.Id, t.Id, t.Name, t.ResponsibleRoleId, t.[Sequence], t.TaskPhaseId, t.Guidance, t.DependsOn, t.ShortName, t.[Workload]
